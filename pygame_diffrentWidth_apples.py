...
def gameLoop():
    ...
    while not gameExit:
        ...
        gameDisplay.fill(white)                     #needs a colour in the argument
        apple_size = 30
        pygame.draw.rect(gameDisplay , red , [apple_x,apple_y,apple_size,apple_size])# increased width 
        ...
        if apple_x <= block_x and apple_x+apple_size >= block_x and apple_y <= block_y and apple_y+apple_size >= block_y:
            apple_x = random.randrange(0,screenSize[0]-block_width,10)
